...
#print_tree(tree)
indices = [random.randint(0,999) for i in range(1000)]  #? don't need i
...
def find_best_split(dataset, labels):
    best_gain = 0
    best_feature = 0
    # Pick 3 features Without replacement
...
print(predictions)
# most commonly predicted classification  would be the random forest’s final classification.
final_prediction = max(predictions, key=predictions.count)
print(final_prediction)

## Test set - accuracy of a single tree and forest
